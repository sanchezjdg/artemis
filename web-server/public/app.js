...
document.getElementById('load-data').addEventListener('click', async () => {
  ...
  document.getElementById('search-interval').innerText = `${startDatetime.replace('T', ' ')} - ${endDatetime.replace('T', ' ')}`;
...
// Button to return to historical form

document.getElementById('return-historical').addEventListener('click', () => {
  document.getElementById('loading-window').style.display = 'none';
  document.getElementById('historical-form').style.display = 'block';
});